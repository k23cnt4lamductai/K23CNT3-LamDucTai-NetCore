...
public partial class LdtBookStoreContext : DbContext
{
    public LdtBookStoreContext()
    {
    }

    public LdtBookStoreContext(DbContextOptions<LdtBookStoreContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-DV4I0GVH\\MSSQLSERVER01;Database=LdtBookStore;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A650255AD6");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C207A4B104D0");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B83F9600A");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCF543A3CD9");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36CE97FF587");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FABEFF13F4D");
